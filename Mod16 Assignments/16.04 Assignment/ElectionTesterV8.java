/**
 * Class ElectionTesterV8 demonstrates traversal algorithms to evaluate 
...
public class ElectionTesterV8
{
   ...
   */
   ...
   //deleting
   public static void delete(List<Candidate> itemList, int location)
    {
        ...
        //{
         ...
         //   for(int index = location; index < itemList.length -1; index++)
          //      itemList.get(index) = itemList.get(index + 1);

          //  itemList.get(itemList.size()-1) = null;
     }
